    ...
    public partial class FrmImport : Form
    {
        ...
        private void btnInsert_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SQLDB.DB.cmdSQL.Parameters.Add("@LID", SqlDbType.VarChar).Value = cboLName.SelectedValue;
        ...
        private void dgvImport_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                if (e.RowIndex >= 0)
                {
                    ...
                    cboLName.SelectedValue = dgvImport["LibrarianID", e.RowIndex].Value.ToString();
